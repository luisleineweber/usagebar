...
export const PROJECT_PULL_URL_PREFIX = `${PROJECT_REPO_URL}/pull/`
export const PROJECT_COMMIT_URL_PREFIX = `${PROJECT_REPO_URL}/commit/`
export const PROJECT_RELEASE_TAG_API_URL_PREFIX = `https://api.github.com/repos/${PROJECT_REPO}/releases/tags/`

...
- Calls Warp's undocumented `GetRequestLimitInfo` app GraphQL endpoint directly.
...
- Migration to an official public usage/limits endpoint if Warp documents one.
